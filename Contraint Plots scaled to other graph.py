...
pyplot.plot(m_b_values*(1/(2.6817268*(10**-4)))*(10**-6),constraint((1,0,1),(2,0,1),10), color='red', label='H: 1s-2s \n 10Hz', linewidth=5.0) 
#pyplot.plot(m_b_values*(1/(2.6817268*(10**-4)))*(10**-6),constraint((1,0,1),(2,0,1),1), color='blue', label='1Hz', linewidth=5.0) 
#pyplot.plot(m_b_values*(1/(2.6817268*(10**-4)))*(10**-6),constraint((1,0,1),(2,0,1),0.1), color='green', label='0.1Hz', linewidth=5.0) 
...
pyplot.plot(m_b_values,constraint((1,0,1),(2,0,1),10), color='red', label='H: 1s-2s \n 10Hz', linewidth=5.0) 
pyplot.xlabel('$m_\phi (1/a_{\mathrm{0}})$', fontsize=40)
pyplot.ylabel('$g_{e}g_{N}$', fontsize=40)
pyplot.yscale('log')
pyplot.ylim(10**-16, 1)
pyplot.xlim(10**-3, 10**6)
pyplot.xscale('log')
pyplot.xticks([10**-3,1,10**3, 10**6], fontsize=30)
pyplot.yticks([10**0,10**-4,10**-8, 10**-12, 10**-16], fontsize=30)
